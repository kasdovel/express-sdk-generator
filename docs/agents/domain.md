...
Multi-context repo layout in this workspace:

```
/
├── CONTEXT-MAP.md
├── docs/adr/                          ← system-wide decisions (ADR-0001 to ADR-0005)
├── packages/
│   ├── core/
│   │   ├── CONTEXT.md                 ← core runtime context glossary (Route, Router, Registry, Transport, etc.)
│   │   └── docs/adr/                  ← core-specific decisions
│   └── cli/
│       ├── CONTEXT.md                 ← CLI & generator context glossary (Operation, Spec, SDK, etc.)
│       └── docs/adr/                  ← CLI-specific decisions
└── examples/
    └── api/
        └── CONTEXT.md                 ← integration & sample app context glossary
```
